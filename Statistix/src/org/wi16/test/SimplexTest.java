...
//		final double[][] nb = new double[][] { { 1, 3, -7, -5, 1, 0, 0, 5 }, { -1, 1, 6, 5, 0, 1, 0, 3 } };
		 final double[] c = new double[] { 6, 10, 8, 12 };
		 final double[][] nb = new double[][] { { 3, 2, -1, 2, 1, 0, 0, 0, 0,
		 60 }, { 1, 1, 2, 1, 0, 1, 0, 0, 0, 45 },
		 { 2, -4, -3, 4, 0, 0, 1, 0, 0, 90 }, { 4, -6, 4, 3, 0, 0, 0, 1, 0,
		 120 },
